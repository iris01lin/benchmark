...
def get_main_args(strings=None):
    ...
    arg("--data", type=str, default="/data/01_2d", help="Path to data directory")
    arg("--results", type=str, default="/results", help="Path to results directory")
    arg("--logname", type=str, default="res_log", help="Name of dlloger output")
    ...
    arg("--cpus", type=non_negative_int, default=0, help="Number of cpus")
    arg("--device", type=str, choices=["hpu", "cpu", "gpu"], default="hpu", help="Device type")
    ...
    arg("--min_epochs", type=non_negative_int, default=1, help="Force training for at least these many epochs")
    arg("--max_epochs", type=non_negative_int, default=10, help="Stop training after this number of epochs")
